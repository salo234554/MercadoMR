                    ...
                    if (
                        ...
                        if (idmicompra == row.idmicompra) {
                            ...
                            let item = {
                                ...
                                token: row.token,
                                uid: row.uid,
                                uidcomprador: row.usuariocompra,
                            ...
                            <div className="container">
                                ...
                                <div className="ps-page__content ps-account">
                                    <Grid container>
                                        {/*Right container */}
                                        <Grid
                                            className="contInfoProdComprCalif desa600px"
                                            item
                                            xs={12}
                                            sm={5}
                                            md={5}
                                            flexDirection={"column"}>
                                            <div className="titlecalifVended mt-[34px]">
                                                <p>Producto vendido: </p>
                                            </div>
                                            <div className="MaininfoLeftMsjVendedorImg" >
                                                <div

                                                    className="infoLeftMsjVendedorImg"
                                                >
                                                    <img
                                                ...
                                                <div
                                                    ...
                                                    className="infoLeftMsjVendedorData"
                                                >
                                                    <h4 className="pNameProductCalif">
                                                        {
                                        ...
                                        <Grid
                                            ...
                                            flexDirection={"column"}>
                                            <div className="titleTproblema mt-[4rem]">
                                        ...
                                        <Grid
                                            ...
                                            md={5}
                                            flexDirection={"column"}>
                                            <div className="titlecalifVendedMobile mt-[34px]">
                                                <p>Producto vendido: </p>
                                            </div>
                                            <Grid container>
                                                <Grid
