...
export default function msjVendedorRedirigir({ UsuarioVendedor }) {
    ...
    const leerMensajes = async () => {
        const datauser = producto.usuariocompra;
            ...
            datax &&
                datax.map((row, index) => {
                    ...
                    if (
                        ...
                        console.log("PRD XXXX : ", producto.idproducto);
