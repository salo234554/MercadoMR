            ...
            <div className="ps-page ps-page--shopping">
                ...
                <div className="container">
                    ...
                    <div className="checkoutMainMobile">
                        <Grid
                            className="checkoutNoMainMobile"
                            container
                            columns={12}>
                            <Grid item xs={12} md={6} sx={{ padding: 1 }}>
                                ...
                                <div className="infoCheckoutMobile">
                                    ...
                                    <div
                                        className="otherAddressButton"
                                        onClick={() => tusDirecciones()}>
                                        <p>
                                            Elegir o agregar una nueva dirección
                                        </p>
                                    </div>
                                </div>
                                ...
                                {prdComprarAhora.length > 0
                                    ? prdComprarAhora &&
                                      prdComprarAhora.map((item, index) => {
                                          return (
                                              <div className="contCheckoutAllInfo">
                                                  <div className="contCheckoutAllInfoTop">
                                                      <div className="contCheckoutAllInfoTopLeft">
                                                          <div className="iconlocatedosMobile">
                                                              <LocalShippingIcon
                                                                  className="locationoniconaddress"
                                                                  style={{
                                                                      fontSize: 30,
                                                      ...
                                                      <div className="contCheckoutAllInfoTopRight">
                                                          <div className="contCheckoutAllInfoDropdown">
                                                              <Dropdown>
                                                                  <Dropdown.Toggle
                                                                      onclick={
                                                                          CustomToggle
                                                                      ...
                                                                      id="dropdown-custom-components"
                                                                      arrowColor="#2D2E83"
                                                                      className="dropdownfechaentregaMombile"
                                                                      variant="outline-light">
                                                                      <div className="ajustecity">
                                                                          <a>
                                                                              {cortarTexto(
                                                                  ...
                                                                  <Dropdown.Menu className="tamañocajafechaentrega">
                                                                      {ent &&
                                                                          ent.map(
                                                                              (
                                                                                  item
                                                          ...
                                                          <div className="contCheckoutAllInfoTopPrice">
                                                              <p>$ 11.500</p>
                                                          </div>
                                                      </div>
                                                  </div>

                                                  <div className="infoMiddleCheckoutAllMobile">
                                                      <img
                                                          className="imageshoppingcarttresMobile"
                                                          src={
                                                              URL_IMAGES_RESULTS +
                                                              item.nombreimagen1
                                                          }
                                                          alt="First slide"
                                                      />
                                                      <div className="infoMiddleCheckoutAllMobileMiddle">
                                                          <h5>
                                                              {
                                                                  item.titulonombre
                                                              }
                                                          </h5>
                                                          <div className="infoMiddleCheckoutDivv">
                                                              <div className="botonCartMlePasarela">
                                                                  <span
                                                                      className={
                                                                          undsel[
                                                                              index
                                                          ...
                                                          <div className="pricesPasarelaMbile">
                                                              <p>
                                                                  Precio
                                                                  unitario: ${" "}
                                                                  {myNumber(
                            ...
                            <Grid item xs={12} md={6} sx={{ padding: 1 }}>
                                <div className="titleCheckoutMobileTop">
                                    <div className="titleTopCheckoutMobile2">
                                        <div className="titleCheckoutMobile2">
                                            <p>Resumen de pedido</p>
                                        </div>

                                        <div className="pricesInfoCheckoutAll">
                                            <div>
                                                <p>
                                                    Total productos (
                                                    {prdComprarAhora.length})
