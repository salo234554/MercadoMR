...
//Importar Carrusel
import VansLatoneria from "../../../CarruselVehiculos/BusesYVans/Vans/VansLatoneria";
...
const VansLatoneriaCentro = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Automóvil Vans");
    ...
    const seleccionaUbicarProductoLatoneria = () => {
        ...
        router.push(
            "/searchinteractive/vansybuses/vans/searchvanslatoneria"
        );
    };
    ...
    const seleccionaUbicarProductoHabitaculo = () => {
        ...
        router.push(
            "/searchinteractive/vansybuses/vans/searchvanshabitaculo"
        );
    };
    ...
    const irLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/vansybuses/vans/searchvanslatoneriaizquierda"
        );
    };
    ...
    const irLatoneriaCentro = () => {
        ...
        router.push(
            "/searchinteractive/vansybuses/vans/searchvanslatoneriacentro"
        );
    };
    ...
    const irLatoneriaDerecha = () => {
        ...
        router.push(
            "/searchinteractive/vansybuses/vans/searchvanslatoneriaderecha"
        );
    };
...
export default VansLatoneriaCentro;
