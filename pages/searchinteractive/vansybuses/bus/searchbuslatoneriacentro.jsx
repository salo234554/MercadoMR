...
//Importar Carrusel
import BusesLatoneriaLatoneria from "../../../CarruselVehiculos/BusesYVans/Bus/BusesLatoneria";
...
const BusesLatoneriaLatoneriaCentro = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Buses");
...
export default BusesLatoneriaLatoneriaCentro;
