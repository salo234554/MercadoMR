...
//Importafotos
import cincopuertasgris from "~/public/buscadorinteractivo/automovilcincopuertas/exterior/basegris.jpg";
...
const SearchInteractiveCincoPuertasLatoneria = (props) => {
                ...
                <div className={zoomTipoVehiculo}>
                    {!closeWindow ? (
                        <div className={controlFijar}>
                                ...
                                <div className="contSearchIntButtons">
                                    <div>
                                        ...
                                        <Button
                                            ...
                                            variant="outline-light"
                                            onClick={
                                                mostrarComentariolatoneriaIzquierda
                                            }>
                                            <i
                                                className={`fa d-flex justify-content-center ${
                                                    !ubicarProductoLatoneria
                                    ...
                                    <div>
                                        ...
                                        <Button
                                            ...
                                            variant="outline-light"
                                            onClick={
                                                mostrarComentariolatoneriaCentro
                                            }>
                                            <i
                                                className={`fa d-flex justify-content-center ${
                                                    !ubicarProductoHabitaculo
                                    ...
                                    <div>
                                        ...
                                        <Button
                                            ...
                                            variant="outline-light"
                                            onClick={
                                                mostrarComentariolatoneriaDerecha
                                            }>
                                            <i
                                                className={`fa d-flex justify-content-center ${
                                                    !ubicarProductoMotor
                            ...
                            <div className="cajacincopuertasimagenlatoneria">
                                <div className="auth__box-logo">
                                    <img src={cincopuertasgris.src} />
                                </div>
                            </div>
...
export default SearchInteractiveCincoPuertasLatoneria;
