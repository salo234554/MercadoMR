...
import ContainerSearch from "~/components/layouts/ContainerSearch";
...
import FooterDefaultSearch from "~/components/shared/footers/FooterDefaultSearch";
...
const SearchInteractiveCincoPuertas = (props) => {
    ...
    const isSmDown = useMediaQuery(theme.breakpoints.down("sm")); // true si es 600px o menos
    ...
    return (
        <ContainerSearch title="Mi Cuenta">
            <div className="App">
            ...
            <div
                className={`${
                    isSmDown ? "rowMobile" : "rowMobile"
                } ps-page ps-page--inner`}
                id="searchmr">
                            ...
                            <div className="mt-57">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/automovilcincopuertas/videocincopuertas.mp4"
                                            type="video/mp4">
                                        </source>
                                    </video>
                                </div>
...
/*
 <div className="auth__box-logo">
                            ...
                            */
export default SearchInteractiveCincoPuertas;
