                ...
                <div className={zoomTipoVehiculo}>
                    {!closeWindow ? (
                        <div className={controlFijar}>
                            ...
                            <img
                                className="espaciologomrmotorelectricomotos"
                                src={logo.src}
                                alt="First slide"
                            />
                            <br />

                            <div className="mtmenos40 ml-110">
                ...
                <Col xs lg={10}>
                    {!onClickImagenMtrElect ? (
                        showImagenMtrElect ? (
                            <Row>
                                <Col xs lg={12}>
                                    <div className="cajasedanimagenesmotorelectricobus pt-9">
                            ...
                            <div className="cajasedanimagenesmotorelectricobus">
                            ...
                            <div className="cajasedanimagenesmotorelectricobus espaciosuperior">
