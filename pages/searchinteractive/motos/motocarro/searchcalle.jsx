...
import imgmoload from "../../../../public/imagesupload/imagennoloa4.jpg";
...
const SearchInteractiveCalle = (props) => {
                        ...
                        <div className={controlFijar}>
                            ...
                            <div className=" ">
                                ...
                                <div className="mt-3 centrartextosedankatoneria">
                                    No tenemos imagenes para esta carroceria
                                </div>
                                <div className="imgenacalleNoHayDiv">
                                    <img
                                        className="imagennoloadNew"
                                        src={imgmoload.src}
                                        alt="First slide"
                                    />
                                </div>
                            ...
                            {/*
<div className="pt-41">
                                <div className="cajaimagenesmotos">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/motos/motocarro/videocalle.mp4"
...
export default SearchInteractiveCalle;
