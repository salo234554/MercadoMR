...
//Importar Carrusel
import EnduroLatoneria from "../../../CarruselVehiculos/Motos/Enduro/EnduroLatoneria";
import ExpandAndCloseSearch from "../../expandandclose/ExpandAndCloseSearch";

const EnduroLatoneriaLatoneriaIzquierda = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Motos Enduro");
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push("/searchinteractive/motos/enduro/searchenduromotorelectrico");
    };

    const irLatoneriaIzquierda = () => {
        dispatch(getFilterSearchInteractive(11));
        router.push(
            "/searchinteractive/motos/enduro/searchendurolatoneriaizquierda"
        );
    };

    const irLatoneriaCentro = () => {
        dispatch(getFilterSearchInteractive(12));
        router.push("/searchinteractive/motos/enduro/searchendurolatoneriacentro");
    };

    const irLatoneriaDerecha = () => {
        dispatch(getFilterSearchInteractive(13));
        router.push("/searchinteractive/motos/enduro/searchendurolatoneriaderecha");
    };
...
export default EnduroLatoneriaLatoneriaIzquierda;
