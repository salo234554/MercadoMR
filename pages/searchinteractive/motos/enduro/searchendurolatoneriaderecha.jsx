...
const EnduroLatoneriaDerecha = (props) => {
    ...
    const irLatoneriaCentro = () => {
        ...
        router.push(
            "/searchinteractive/motos/enduro/searchendurolatoneriacentro"
        );
    };
    ...
    const irLatoneriaDerecha = () => {
        ...
        router.push(
            "/searchinteractive/motos/enduro/searchendurolatoneriaderecha"
        );
    };
                            ...
                            <Row>
                                <Col xs lg={7}>
                                    <div className="cajaimagenesmotos auth__box-logo">
                                        <EnduroLatoneria ubicacion={"derecha"} />
                                    </div>
                                </Col>
                            </Row>
...
/*
 <div className="auth__box-logo">
                            ...
                            */
export default EnduroLatoneriaDerecha;
