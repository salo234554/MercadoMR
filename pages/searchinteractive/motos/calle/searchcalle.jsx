...
const SearchInteractiveCalle = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Motos de Calle");
    ...
    const seleccionaUbicarProductoLatoneria = () => {
        ...
        router.push(
            "/searchinteractive/motos/calle/searchcallelatoneria"
        );
    };
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        setUbicarProductoLatoneria(false);
        router.push(
            "/searchinteractive/motos/calle/searchcallemotorelectrico"
        );
    };
                        ...
                        <div className={controlFijar}>
                            ...
                            <div className=" ">
                                ...
                                <BotoneraMotos
                                    ...
                                    seleccionadoono={0}
                                    tercerboton={0}
                                    onClickBoton3={seleccionaUbicarProductoLatoneria}
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/motos/calle/videocalle.mp4"
