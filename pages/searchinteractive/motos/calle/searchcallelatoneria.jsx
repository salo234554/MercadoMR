...
//Importafotos
import busgris from "~/public/buscadorinteractivo/motos/calle/exterior/basegris.jpg";
...
const SearchInteractiveBusLatoneria = (props) => {
    ...
    const mostrarComentariolatoneria = () => {
        ...
        setTextoUnoModalInformacion(
            "Aquí están ubicados los productos en la parte exterior de la motocicleta"
        );
    ...
    const seleccionaUbicarProductoLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/motos/calle/searchcallelatoneriaizquierda"
        );
    };
    ...
    const seleccionaUbicarProductoLatoneriaCentro = () => {
        ...
        dispatch(getDataSelectedExternal(DatoSeleccionadoLatoneria));
        router.push(
            "/searchinteractive/motos/calle/searchcallelatoneriacentro"
        );
    };
    ...
    const seleccionaUbicarProductoLatoneriaDerecha = () => {
        ...
        dispatch(getDataSelectedExternal(DatoSeleccionadoLatoneria));
        router.push(
            "/searchinteractive/motos/calle/searchcallelatoneriaderecha"
        );
    };
...
export default SearchInteractiveBusLatoneria;
