...
//Importar Carrusel
import CalleLatoneria from "../../../CarruselVehiculos/Motos/Touring/TouringLatoneria";
...
const CalleLatoneriaDerecha = (props) => {
    ...
    const irLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/motos/touring/searchtouringlatoneriaizquierda"
        );
    };
    ...
    const irLatoneriaCentro = () => {
        ...
        router.push(
            "/searchinteractive/motos/touring/searchtouringlatoneriacentro"
        );
    };
    ...
    const irLatoneriaDerecha = () => {
        ...
        router.push(
            "/searchinteractive/motos/touring/searchtouringlatoneriaderecha"
        );
    };
                    ...
                    {!closeWindow ? (
                        <div className={controlFijar}>
                            ...
                            <div className="mt-3 centrartextosexterior">
                                Elige en que parte de la motocicleta está
                                ubicado tu repuesto
                            </div>
                            <Row>
                                <Col xs lg={11}>
