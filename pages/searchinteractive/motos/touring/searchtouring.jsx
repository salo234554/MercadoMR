...
const SearchInteractiveTouring = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Motos Touring");
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/motos/touring/videotouring.mp4"
...
export default SearchInteractiveTouring;
