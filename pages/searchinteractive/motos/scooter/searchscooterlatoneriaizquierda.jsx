...
const ScooterLatoneriaLatoneriaIzquierda = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push("/searchinteractive/motos/scooter/searchscootermotorelectrico");
    };
    ...
    const irLatoneriaCentro = () => {
        ...
        router.push("/searchinteractive/motos/scooter/searchscooterlatoneriacentro");
    };

    const irLatoneriaDerecha = () => {
        dispatch(getFilterSearchInteractive(13));
        router.push("/searchinteractive/motos/scooter/searchscooterlatoneriaderecha");
    };
...
export default ScooterLatoneriaLatoneriaIzquierda;
