...
const SearchInteractiveTresPuertasLatoneriaCentro = (props) => {
    ...
    const mostrarComentariohabitaculo = () => {
        ...
        setShowModalComentariosLatoneria(true);
        setTextoUnoModalInformacion(
            "Aquí estan ubicados los productos en la parte exterior centro del vehículo."
        );
        setTextoDosModalInformacion(
            "Los componentes del Extrior del vehículo como farolas, capo, baul u otros elementos."
        );
    };
...
export default SearchInteractiveTresPuertasLatoneriaCentro;
