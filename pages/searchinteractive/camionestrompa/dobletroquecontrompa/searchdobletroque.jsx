...
import FilterContentMobileInteractive from "~/components/partials/shop/modules/FilterContentMobileInteractive";
import ExpandAndCloseSearch from "../../expandandclose/ExpandAndCloseSearch";

const SearchInteractiveDobleTroque = (props) => {
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/camionestrompa/dobletroquecontrompa/dobletroquecontrompa.mp4"
...
export default SearchInteractiveDobleTroque;
