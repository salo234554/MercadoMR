...
//Importafotos
import estacasencillagris from "~/public/buscadorinteractivo/camionetas/estacacabinasencilla/exterior/basegris.jpg";
...
const SearchInteractiveEstacaSencillaLatoneria = (props) => {
                        ...
                        <div className={controlFijar}>
                            ...
                            <div className="cajatrespuertasimagenlatoneria">
                                <div className="auth__box-logo">
                                    <img src={estacasencillagris.src} />
                                </div>
                            </div>
...
export default SearchInteractiveEstacaSencillaLatoneria;
