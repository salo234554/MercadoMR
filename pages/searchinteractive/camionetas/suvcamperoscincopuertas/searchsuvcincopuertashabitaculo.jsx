...
//Importafotos
import suvcincopuertashabitaculo from "~/public/buscadorinteractivo/camionetas/suvcamperoscincopuertas/interior/general.jpg";
import suvcincopuertashabitaculoconsola from "~/public/buscadorinteractivo/camionetas/suvcamperoscincopuertas/interior/tablero.jpg";
import suvcincopuertashabitaculoasientos from "~/public/buscadorinteractivo/camionetas/suvcamperoscincopuertas/interior/asientos.jpg";
import suvcincopuertashabitaculotecho from "~/public/buscadorinteractivo/camionetas/suvcamperoscincopuertas/interior/techo.jpg";
...
const SUVCincoPuertasHabitaculo = (props) => {
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    suvcincopuertashabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    suvcincopuertashabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    suvcincopuertashabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default SUVCincoPuertasHabitaculo;
