...
const SearchInteractiveSUVCincoPuertas = (props) => {
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/camionetas/suvcamperoscincopuertas/suvcincopuertas.mp4"
...
export default SearchInteractiveSUVCincoPuertas;
