...
//Importafotos
import doblevolcogris from "~/public/buscadorinteractivo/camionetas/volcodoblecabina/exterior/basegris.jpg";
...
const SearchInteractiveDobleVolcoLatoneria = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Vehiculos platón doble cabina");
    ...
    const seleccionaUbicarProductoLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/camionetas/volcodoblecabina/searchdoblevolcolatoneriaizquierda"
        );
    };
    ...
    const seleccionaUbicarProductoLatoneriaCentro = () => {
        ...
        dispatch(getDataSelectedExternal(DatoSeleccionadoLatoneria));
        router.push(
            "/searchinteractive/camionetas/volcodoblecabina/searchdoblevolcolatoneriacentro"
        );
    };
    ...
    const seleccionaUbicarProductoLatoneriaDerecha = () => {
        ...
        dispatch(getDataSelectedExternal(DatoSeleccionadoLatoneria));
        router.push(
            "/searchinteractive/camionetas/volcodoblecabina/searchdoblevolcolatoneriaderecha"
        );
    };
                    ...
                    {!closeWindow ? (
                        <div className={controlFijar}>
                            ...
                            <BotoneraUbicacionInicio
                                onClickBoton1={seleccionaUbicarProductoLatoneriaIzquierda}
                                infoBoton1={mostrarComentariolatoneria}
                                labelBoton1="Izquierda"
                                onClickBoton2={seleccionaUbicarProductoLatoneriaCentro}
                                infoBoton2={mostrarComentariohabitaculo}
                                labelBoton2="Centro"
                                onClickBoton3={seleccionaUbicarProductoLatoneriaDerecha}
                                infoBoton3={mostrarComentariomotor}
                                labelBoton3="Derecha"
                                seleccionado={3}
                                colorActived={1}
...
export default SearchInteractiveDobleVolcoLatoneria;
