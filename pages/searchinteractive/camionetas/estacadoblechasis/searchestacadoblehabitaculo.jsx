...
//Importafotos
import estacadoblehabitaculo from "~/public/buscadorinteractivo/camionetas/estacadoblechasis/interior/general.jpg";
import estacadoblehabitaculoconsola from "~/public/buscadorinteractivo/camionetas/estacadoblechasis/interior/tablero.jpg";
import estacadoblehabitaculoasientos from "~/public/buscadorinteractivo/camionetas/estacadoblechasis/interior/asientos.jpg";
import estacadoblehabitaculotecho from "~/public/buscadorinteractivo/camionetas/estacadoblechasis/interior/techo.jpg";
...
const EstacaDobleHabitaculo = (props) => {
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    estacadoblehabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    estacadoblehabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    estacadoblehabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default EstacaDobleHabitaculo;
