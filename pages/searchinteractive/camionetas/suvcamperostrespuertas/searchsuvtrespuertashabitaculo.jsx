...
//Importafotos
import suvtrespuertashabitaculo from "~/public/buscadorinteractivo/camionetas/suvcamperostrespuertas/interior/general.jpg";
import suvtrespuertashabitaculoconsola from "~/public/buscadorinteractivo/camionetas/suvcamperostrespuertas/interior/tablero.jpg";
import suvtrespuertashabitaculoasientos from "~/public/buscadorinteractivo/camionetas/suvcamperostrespuertas/interior/asientos.jpg";
import suvtrespuertashabitaculotecho from "~/public/buscadorinteractivo/camionetas/suvcamperostrespuertas/interior/techo.jpg";
...
const EstacaSencillaHabitaculo = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        if (tipovehsel != 4) {
            router.push(
                "/searchinteractive/camionetas/suvcamperostrespuertas/searchsuvtrespuertasmotorelectrico"
            );
        } else {
            router.push(
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    suvtrespuertashabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    suvtrespuertashabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    suvtrespuertashabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default EstacaSencillaHabitaculo;
