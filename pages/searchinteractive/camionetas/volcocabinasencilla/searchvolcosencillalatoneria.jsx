...
//Importafotos
import volcosencillagris from "~/public/buscadorinteractivo/camionetas/volcocabinasencilla/exterior/basegris.jpg";
...
const SearchInteractiveVolcoSencillaLatoneria = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Vehiculos platón sencilla");
...
export default SearchInteractiveVolcoSencillaLatoneria;
