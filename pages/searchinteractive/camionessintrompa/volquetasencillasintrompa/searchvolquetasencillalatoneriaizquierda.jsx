...
const EstacaSencillaLatoneriaIzquierda = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Volqueta sencilla sin trompa");
...
export default EstacaSencillaLatoneriaIzquierda;
