...
//Importafotos
import volquetadoblehabitaculo from "~/public/buscadorinteractivo/camionessintrompa/volquetadoblesintrompa/interior/general.jpg";
import volquetadoblehabitaculoconsola from "~/public/buscadorinteractivo/camionessintrompa/volquetadoblesintrompa/interior/tablero.jpg";
import volquetadoblehabitaculoasientos from "~/public/buscadorinteractivo/camionessintrompa/volquetadoblesintrompa/interior/asientos.jpg";
import volquetadoblehabitaculotecho from "~/public/buscadorinteractivo/camionessintrompa/volquetadoblesintrompa/interior/techo.jpg";
...
const VolquetaDobleHabitaculo = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push(
            "/searchinteractive/camionessintrompa/volquetadoblesintrompa/searchvolquetadoblemotorelectrico"
        );
    };
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volquetadoblehabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volquetadoblehabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volquetadoblehabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default VolquetaDobleHabitaculo;
