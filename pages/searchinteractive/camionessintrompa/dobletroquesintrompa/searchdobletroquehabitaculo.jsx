...
//Importafotos
import dobletroquehabitaculo from "~/public/buscadorinteractivo/camionessintrompa/dobletroquesintrompa/interior/general.jpg";
import dobletroquehabitaculoconsola from "~/public/buscadorinteractivo/camionessintrompa/dobletroquesintrompa/interior/tablero.jpg";
import dobletroquehabitaculoasientos from "~/public/buscadorinteractivo/camionessintrompa/dobletroquesintrompa/interior/asientos.jpg";
import dobletroquehabitaculotecho from "~/public/buscadorinteractivo/camionessintrompa/dobletroquesintrompa/interior/techo.jpg";
...
const DobleTroqueHabitaculo = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push(
            "/searchinteractive/camionessintrompa/dobletroquesintrompa/searchdobletroquemotorelectrico"
        );
    };
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    dobletroquehabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    dobletroquehabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    dobletroquehabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default DobleTroqueHabitaculo;
