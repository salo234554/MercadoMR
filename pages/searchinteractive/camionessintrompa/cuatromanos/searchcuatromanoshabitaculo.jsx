...
//Importafotos
import cuatromanoshabitaculo from "~/public/buscadorinteractivo/camionessintrompa/cuatromanos/interior/general.jpg";
import cuatromanoshabitaculoconsola from "~/public/buscadorinteractivo/camionessintrompa/cuatromanos/interior/tablero.jpg";
import cuatromanoshabitaculoasientos from "~/public/buscadorinteractivo/camionessintrompa/cuatromanos/interior/asientos.jpg";
import cuatromanoshabitaculotecho from "~/public/buscadorinteractivo/camionessintrompa/cuatromanos/interior/techo.jpg";
...
const CuatroManosHabitaculo = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push(
            "/searchinteractive/camionessintrompa/cuatromanos/searchcuatromanosmotorelectrico"
        );
    };
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    cuatromanoshabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    cuatromanoshabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    cuatromanoshabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default CuatroManosHabitaculo;
