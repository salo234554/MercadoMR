...
function index(props) {
    ...
    const verResultadosPrd = () => {
        /* Se solicita eliminar esta información en los resultados de la busqueda*/

        let datosbusqueda = selectCarroceria + "; " + selectMarca + "; " + selectAnno + "; " +
            selectModelo + "; " + selectCilindraje + "; " + selectTransmision

        localStorage.setItem("eraseplaceholder", JSON.stringify(0));
        localStorage.setItem("placeholdersearch", JSON.stringify(datosbusqueda));
        //localStorage.setItem("inputdata", JSON.stringify(datosbusqueda));
    ...
    return (
        <ContainerResult>
            <div className={dataSearch ? "containerContactanosCompleta" : "containercontactanos"}>
                ...
                }
                {
                    !dataSearch ?
                            ...
                            openCloseDatosVeh == 0 ?
                                (
                                    <div className="divcontactanos">
                                        ...
                                        <div className="px-[15px]">
                                            ...
                                            <div className="flex justify-end gap-[10px] mt-[15px]">
                                                <Button
                                                ...
                                                <Button
                                                    className="botondatostuvehiculodos m-0"
                                                    variant="outline-light"
                                ...
                                : openCloseDatosVeh == 1 ?
                                    (
                                        <div>
                                            <div className="mt-10">
                                                <div className="NewContContactanos">
                                                    <div className="NewContContactanosLeft">
                                                        <p>
                                                            {selectCarroceria}{"; "}
                                                    ...
                                                    <div className="NewContContactanosRight">
                                                        <LuChevronDown onClick={() => openDatVeh()} />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="divinfotuvehiculo">
                                                <div className="InfoContactBar">
                                                    <IoSearchSharp />
                                                    <p>Tenemos {numReg} resultado(s) relacionados con el vehículo ingresado</p>
                                                </div>
                                    ...
                                    openCloseDatosVeh == 2 ?
                                        (
                                            <div>
                                                ...
                                                <div className="mt-3">
                                                    <div className="InfoContactBar-contact">
                                                        <IoSearchSharp />
                                                        <p>Tenemos {numReg} resultado(s) relacionados con el vehículo ingresado</p>
                                                    </div>
                                                </div>
                                                <div className="divinfotuvehiculo">
                                                    <div className="ValidDataText">
                                                        <p>Valida los datos para enviarte la información</p>
                                                    </div>


                                                    <div className="titleSendContactanos">
                                                        <p>Correo electrónico</p>
                                                    </div>

                                                    <div className="inputDivSendContactanos">
                                                        <input
                        ...
                        :
                        <>
                            <div className={dataSearch ? "searchContactanosMsub" : "mlmenos230"}>
                                <SearchContact
                                    dataFind={dataFind}
