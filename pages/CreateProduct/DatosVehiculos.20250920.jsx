...
const CustomMenu = React.forwardRef(
    ({ children, style, className, "aria-labelledby": labeledBy }, ref) => {
        ...
        useEffect(() => {
            localStorage.setItem("newdatavehiculo", JSON.stringify(value));
        }, [value]);
...
function DatosVehiculos(props) {
    ...
    const [dropdownOpenMarca, setDropdownOpenMarca] = useState(false);
    const [dropdownOpenModelo, setDropdownOpenModelo] = useState(false);
    const [dropdownOpenCilindraje, setDropdownOpenCilindraje] = useState(false);
    ...
    useEffect(() => {
        let newdatavehiculo = JSON.parse(
            localStorage.getItem("newdatavehiculo")
        );
        if (newdatavehiculo) {
            setSelectMarca(newdatavehiculo);
            handleChangeBrand(newdatavehiculo);
        }
    }, [dropdownOpenMarca]);
    ...
    useEffect(() => {
        ...
        if (newdatavehiculo) {
            setSelectModelo(newdatavehiculo);
            handleChangeModels(newdatavehiculo);
        }
    }, [dropdownOpenModelo]);
    ...
    useEffect(() => {
        ...
        if (newdatavehiculo) {
            setSelectCilindraje(newdatavehiculo);
            handleChangeVersionMotor(newdatavehiculo);
        }
    }, [dropdownOpenCilindraje]);
    ...
    }, [numeroVehiculosAgregados, tipoVehSelec, duplicarprd]);
    ...
    useEffect(() => {
        ...
        if (duplicarprd === 2) {
            let newDet = [];
            datosgenerales.vgl_carroceriasvehiculos &&
                datosgenerales.vgl_carroceriasvehiculos.forEach((row) => {
                    if (
                        Number.parseInt(row.tipovehiculo) ===
                        Number.parseInt(tipoVeh)
                    ) {
            ...
            //console.log("CARROCE SSS : ",newDet)
    ...
    const scrollDown = () => {
        if (listRef.current) {
            ...
            const scrollAmount = 10; // Desplazar 10px
    ...
    const handleScroll = () => {
        ...
        // Usa margen de error pequeño para evitar que 0.5 te haga fallar
        setShowTopFade(scrollTop > 1);
        setShowBottomFade(scrollBottom < scrollHeight - 1);
    };
    ...
    const handleClickAway = () => {
        setDropdownOpenMarca(false);
    };

    const handleClickAwayModelo = () => {
        setDropdownOpenModelo(false);
    };
            ...
            <div>
                <SwitchTransition>
                    <CSSTransition
                        ...
                        <div className="divDatosVehiculo">
                            <Col className="paddingVenderSegundo">
                                <div className="px-[10px]">
                                    <div className="DivDatosVehiculoDos">
                                        <div className="DivDatosVehiculoDosDrop">
                                            <Dropdown
                                                style={{ width: "100%" }}
                                        ...
                                        <div className="DivDatosVehiculoDosIcons">
                                            <div className="cajaiconoguardar">
                                                <CheckIcon
                                                    ...
                                                    className="iconocancelarguardar "></CheckIcon>
                                            </div>
                                            ...
                                            <div>
                                                <Dropdown
                                                    ...
                                                    <Dropdown.Menu
                                                        ...
                                                        // El contenedor del dropdown tiene position: relative
                                                    >
                                                        <div className="tamañocajaoptionsitems ">
                                                            <div className="fade1 fade-top1" />
                                                            {/* <div style={{ position: "relative" }} ref={listRef}  onScroll={handleScroll}> */}
                                                            {numeroVehiculosAgregados ===
                                                            0
                                                                ? carrocerias &&
                                                                  carrocerias.map(
                                    ...
                                    <Row>
                                        ...
                                        {!nuevoVehiculo ? (
                                            <Col xs={12} sm={5} className="p-0">
                                                <ClickAwayListener
                                                    onClickAway={
                                                        handleClickAwayModelo
                                                    }>
                                                    <div
                                                        onClick={() =>
                                                            setDropdownOpenModelo(
                                                                true
                                                            )
                                                        }>
                                                        <Dropdown
