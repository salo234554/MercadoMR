...
function ModalInfoPosicionPrdExtIzq({
    shown,
    close,
    texto,
    ...
    const selectCarroceria = (codigo, label) => {
        ...
        if (codigo == 24) {
            imagensel = "/buscadorinteractivo/sedan/exterior/izquierda/1.jpg";
            setImagen(imagensel);
        } else if (codigo == 8) {
            imagensel = "/buscadorinteractivo/coupe/exterior/izquierda/1.jpg";
            setImagen(imagensel);
        } else if (codigo == 2) {
            imagensel =
...
export default ModalInfoPosicionPrdExtIzq;
