...
const ModuleProductImagesResultsDosSearchInt = ({ product }) => {
    ...
    return (
        <div
            className="ps-product__images apuntador ml-10-dinamico"
            onClick={() => verProduct(product.id)}
            onMouseEnter={() => mostrarNombre()}
            onMouseLeave={() => ocultarNombre()}>
            <img
                className="imageresultResultS"
                src={URL_IMAGES_RESULTS + product.images[0].name}
                alt="First slide"
            />
            <div className="textoubicacionproductoprecioIntSe">
...
export default ModuleProductImagesResultsDosSearchInt;
