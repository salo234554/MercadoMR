...
import VehicleOverviewDelete from "./VehicleOverviewDelete";
...
const Deleting = ({ vehicles }: Props) => {
    ...
    const accept = async () => {
        ...
        dispatch(getCtlrVehSelected(null));
    };

    const cancelDeleteVeh = async () => {
    ...
    return (
        <Container>
            ...
            {vehicle && (
                <VehicleOverviewDelete type={state.Delete} vehicle={vehicle} />
            )}
