...
const ProductListPhotoImageSearch = ({ product }) => {
    ...
    return (
        <>
            <div className="ps-product ps-product--horizontal none915px">
                ...
                <div
                    className="ps-product__thumbnail cajaimageresultlist apuntador"
                ...
                <div className="mobileContainerReultsRRight">
                    ...
                    <div className="itemRightCartResults">
                      ...
                      <div
                        ...
                        onClick={() => {
                            if (product.numerounidades && product.numerounidades > 0) {
...
export default ProductListPhotoImageSearch;
