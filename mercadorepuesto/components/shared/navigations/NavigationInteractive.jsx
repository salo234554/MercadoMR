...
import ModuleHeaderInteractive from "~/components/shared/headers/modules/ModuleHeaderInteractive";
...
const NavigationInteractive = (props) => {
    ...
    const cambiodireccion = useSelector((state) => state.cambiodireccion.cambiodireccion);
    ...
    useEffect(() => {
        ...
        const obtenerDireccionUsuario = async () => {
            ...
            try {
                ...
                const direccionesOrdenadas = res.data.listardireccionesusuario.sort((a, b) => new Date(b.fechacreacion).getTime() - new Date(a.fechacreacion).getTime());
    ...
    return (
        <nav className="navigation--primary">
            <div ref={irA}>
                ...
                <div className="container show1050Nav" onClick={() => handleClick()}>
                ...
                <div className="hidde1050Nav" onClick={() => handleClick()}>
                    {datosusuarios && datosusuarios.uid ? (
                        <div className="hidde850NavIcons">
                            <div onClick={() => cambiarDireccion()} className="ubiMobileNav">
                                <IoLocationSharp /> <p>Enviar a {direccion?.nombreciudad} <IoChevronForward /></p>
                            </div>
                            ...
                            <div className="iconsRightNavMobile">
                                ...
                                <div className="kart-mobile-menu-main-primary">
                                    <div
                                        className={`kart-mobile-menu ${!datosusuarios || !datosusuarios.uid ? 'kart-unable' : ''}`}
                                        onClick={() => {
                                            if (!datosusuarios || !datosusuarios.uid) return;
                                ...
                                <div className="kart-mobile-menu-main-primary">
                                    <div
                                        ...
                                        onClick={() => {
                                            if (!datosusuarios || !datosusuarios.uid) return;
                                            handleIrVerificado('/shop/wishlist');
                                        }}
                                    >
                                        <GoHeart />
                        ...
                        <span>
                            <h4 onClick={handleCreateAccount}>Crea tu cuenta</h4>
...
export default NavigationInteractive;
