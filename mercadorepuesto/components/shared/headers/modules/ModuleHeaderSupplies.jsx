...
const ModuleHeaderSupplies = ({ opencategorias }) => {
    ...
    const [classCagetoria, setClassCagetoria] = useState("divcategorias2");
    ...
    const selSubCategoria = (nombresub, codigoposicion) => {
        ...
        /*
        router.push({
            pathname: `/search?keyword=${string}`,
            query: {
                posicionprd: JSON.stringify(codigoposicion),
            },
        });
        */
    };
    ...
    useEffect(() => {
        /*
        if (categoriaActiva == 3 || categoriaActiva == 4) {
            setClassCagetoria("divcategorias");
        } else if (categoriaActiva == 2) {
            setClassCagetoria("divcategorias1");
        } else {
            setClassCagetoria("divcategorias2");
        }
            */
    }, [categoriaActiva]);
    ...
    return (
        <div className="header__supplies" ref={irA}>
                ...
                <Popover
                    ...
                    <div className="ContainerCategoriasLeft">
                                                  ...
                                                  <button
                                                      ...
                                                      onMouseOver={() => {
                                                          ...
                                                          setDescripcionActiva(
                                                              ""
                                                          ); // Borramos la descripción activa al cambiar de categoría
                                                      ...
                                                      onMouseEnter={() =>
                                                          openMensajeCategorias(
                                                              categoria.id
                                                          )
                                                      }
                                                      onMouseOut={() =>
                                                          closeMensajeCategorias(
                                                              null
                                                          )
                                                      }
                                                      style={{
                        ...
                        <div className="subCategoriasLeft">
                            {categoriaActiva === 3 && (
                                <div
                                    className="circuloIconoInferior"
                                    onClick={scrollToDescripcion}>
                            ...
                            <div
                                className={`contRightOVerflowCat ${
                                    categoriaActiva === 4
                                        ? "ml-2remCats"
                                        : "ml-5remCats"
                                }`}
                                ...
                                <div
                                    className="contDescripcionSubCat"
                                    ref={descripcionRef}>
                                    {descripcionActiva && (
