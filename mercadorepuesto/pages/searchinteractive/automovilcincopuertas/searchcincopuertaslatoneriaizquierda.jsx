...
const SearchInteractiveCincoPuertasLatoneriaIzquierda = (props) => {
                    ...
                    {!closeWindow ? (
                        <div className={controlFijar}>
                            ...
                            <BotoneraUbicacion
                                ...
                                infoBoton1={mostrarComentariolatoneriaIzquierda}
...
export default SearchInteractiveCincoPuertasLatoneriaIzquierda;
