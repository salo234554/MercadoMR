...
//Importafotos
import cincopuertashabitaculo from "~/public/buscadorinteractivo/automovilcincopuertas/interior/general.jpg";
import cincopuertashabitaculoconsola from "~/public/buscadorinteractivo/automovilcincopuertas/interior/tablero.jpg";
import cincopuertashabitaculoasientos from "~/public/buscadorinteractivo/automovilcincopuertas/interior/asientos.jpg";
import cincopuertashabitaculotecho from "~/public/buscadorinteractivo/automovilcincopuertas/interior/techo.jpg";
...
const SearchInteractiveCincoPuertasHabitaculo = (props) => {
                            ...
                            <div className={classBotonera}>
                                <Row className="topSearchIntButtons">
                                    <div className="contSearchIntButtons">
                                        <div>
                                            <Button
                                                className="botonPartCarroceriaDeseleccionado"
                                            ...
                                            <Button
                                                className="infoButtonNewSearchDeseleccionado"
                                                variant="outline-light"
                                                onClick={
                                                    mostrarComentariolatoneria
                                                }>
                                                <i
                                                    className={`fa d-flex justify-content-center ${
                                    ...
                                    <div className="buttonstopIntMobile">
                                        <div className="topSearchIntButtonsMobile">
                                            <div>
                                                <Button
                                                    className="botonPartCarroceriaMobileDeseleccionado"
                                                    variant="outline-light"
                                                    onClick={
                                                        seleccionaUbicarProductoLatoneria
                                                    }>
                                ...
                                <div className="contSearchIntButtons">
                                    <div>
                                        <Button
                                            ...
                                            variant="outline-light"
                                            onClick={seleccionaParteConsola}>
                                            Consola
                                        </Button>
                                        <Button
                                            className={
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        <div>
                                            <img
                                                ...
                                                src={cincopuertashabitaculo.src}
                                            />
                                        </div>
                                    ) : ubicarProductoConsola ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    cincopuertashabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    cincopuertashabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    cincopuertashabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default SearchInteractiveCincoPuertasHabitaculo;
