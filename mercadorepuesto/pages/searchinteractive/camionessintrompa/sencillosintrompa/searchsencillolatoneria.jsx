...
//Importafotos
import sencillogris from "~/public/buscadorinteractivo/camionessintrompa/sencillosintrompa/exterior/basegris.jpg";
...
const SearchInteractiveSencilloLatoneria = (props) => {
    ...
    const seleccionaUbicarProductoLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/camionessintrompa/sencillosintrompa/searchsencillolatoneriaizquierda"
        );
    };
    ...
    const seleccionaUbicarProductoLatoneriaCentro = () => {
        ...
        dispatch(getDataSelectedExternal(DatoSeleccionadoLatoneria));
        router.push(
            "/searchinteractive/camionessintrompa/sencillosintrompa/searchsencillolatoneriacentro"
        );
    };
    ...
    const seleccionaUbicarProductoLatoneriaDerecha = () => {
        ...
        dispatch(getDataSelectedExternal(DatoSeleccionadoLatoneria));
        router.push(
            "/searchinteractive/camionessintrompa/sencillosintrompa/searchsencillolatoneriaderecha"
        );
    };
...
export default SearchInteractiveSencilloLatoneria;
