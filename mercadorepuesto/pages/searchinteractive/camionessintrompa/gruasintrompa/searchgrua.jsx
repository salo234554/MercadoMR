...
const SearchInteractiveGrua = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Grúa sin trompa");
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/camionessintrompa/gruasintrompa/gruasintrompa.mp4"
...
export default SearchInteractiveGrua;
