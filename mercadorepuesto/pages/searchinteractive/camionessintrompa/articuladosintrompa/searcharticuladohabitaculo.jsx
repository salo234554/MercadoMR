...
//Importafotos
import articuladohabitaculo from "~/public/buscadorinteractivo/camionessintrompa/articuladosintrompa/interior/general.jpg";
import articuladohabitaculoconsola from "~/public/buscadorinteractivo/camionessintrompa/articuladosintrompa/interior/tablero.jpg";
import articuladohabitaculoasientos from "~/public/buscadorinteractivo/camionessintrompa/articuladosintrompa/interior/asientos.jpg";
import articuladohabitaculotecho from "~/public/buscadorinteractivo/camionessintrompa/articuladosintrompa/interior/techo.jpg";
...
const ArticuladoHabitaculo = (props) => {
    ...
    const mostrarComentarioConsola = () => {
        ...
        setShowModalComentariosLatoneria(true);
        setTextoUnoModalInformacion(
            "La consola central de un automóvil se refiere al espacio que se encuentra entre los dos asientos delanteros."
        );
        setTextoDosModalInformacion(
            "Esta ubicada entre los asientos delanteros. Puede incluir espacios para el almacenamiento, portavasos, controles del sistema, aire acondicionado, entre otros sistemas."
        );
    };

    const mostrarComentarioAsientos = () => {
        setShowModalComentariosLatoneria(true);
        setShowModalComentariosLatoneria(true);
        setTextoUnoModalInformacion(
            "Asientos del vehículo, conductor y pasajeros del vehiculo"
        );
        setTextoDosModalInformacion(
            "Los asientos del automóvil, contribuyen a la seguridad, el confort al volante y la eficiencia de combustible. Los asientos inteligentes permiten recordar y ajustar manual o automáticamente la posición de cada conductor.."
        );
    };
    ...
    const mostrarComentarioTecho = () => {
        ...
        setShowModalComentariosLatoneria(true);
        setTextoUnoModalInformacion(
            "El techo de un vehículo es la parte que está sobre el habitáculo de pasajeros y protege a los ocupantes. "
        );
        setTextoDosModalInformacion(
            "El techo del vehículo puede incluir barras de techo, rieles de techo, puntos de fijación, y en algunos casos, techos solares."
        );
    };
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push(
            "/searchinteractive/camionessintrompa/articuladosintrompa/searcharticuladomotorelectrico"
        );
    };
    ...
    useEffect(() => {
        let bloquear = "";
        if (blockscreen == 1)
            bloquear = "mt-20 fijardatosvehiculohabitaculo deshabilitardos";
        else bloquear = "mt-20 fijardatosvehiculohabitaculo habilitar";
