...
//Importar Carrusel
import VolquetaDobleLatoneria from "../../../CarruselVehiculos/CamionesSinTrompa/VolquetaDobleSinTrompa/VolquetaDobleLatoneria";
...
const VolquetaDobleLatoneriaCentro = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Volqueta doble sin trompra");
    ...
    const irLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/camionessintrompa/volquetadoblesintrompa/searchvolquetadoblelatoneriaizquierda"
        );
    };
    ...
    const irLatoneriaCentro = () => {
        ...
        router.push(
            "/searchinteractive/camionessintrompa/volquetadoblesintrompa/searchvolquetadoblelatoneriacentro"
        );
    };
    ...
    const irLatoneriaDerecha = () => {
        ...
        router.push(
            "/searchinteractive/camionessintrompa/volquetadoblesintrompa/searchvolquetadoblelatoneriaderecha"
        );
    };
...
export default VolquetaDobleLatoneriaCentro;
