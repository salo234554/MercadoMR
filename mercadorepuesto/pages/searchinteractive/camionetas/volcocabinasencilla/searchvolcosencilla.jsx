...
const SearchInteractiveVolcoSencilla = (props) => {
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/camionetas/volcocabinasencilla/camionetasencillavolco.mp4"
...
/*
 <div className="auth__box-logo">
                            ...
                            */
export default SearchInteractiveVolcoSencilla;
