...
//Importafotos
import volcosencillahabitaculo from "~/public/buscadorinteractivo/camionetas/volcocabinasencilla/interior/general.jpg";
import volcosencillahabitaculoconsola from "~/public/buscadorinteractivo/camionetas/volcocabinasencilla/interior/tablero.jpg";
import volcosencillahabitaculoasientos from "~/public/buscadorinteractivo/camionetas/volcocabinasencilla/interior/asientos.jpg";
import volcosencillahabitaculotecho from "~/public/buscadorinteractivo/camionetas/volcocabinasencilla/interior/techo.jpg";
...
const VolcoSencillaHabitaculo = (props) => {
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volcosencillahabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volcosencillahabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volcosencillahabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default VolcoSencillaHabitaculo;
