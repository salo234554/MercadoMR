...
const SearchInteractiveEstacaSencilla = (props) => {
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/camionetas/estacacabinasencilla/camionetasencillachasis.mp4"
...
export default SearchInteractiveEstacaSencilla;
