...
//Importafotos
import doblevolcohabitaculo from "~/public/buscadorinteractivo/camionetas/volcodoblecabina/interior/general.jpg";
import doblevolcohabitaculoconsola from "~/public/buscadorinteractivo/camionetas/volcodoblecabina/interior/tablero.jpg";
import doblevolcohabitaculoasientos from "~/public/buscadorinteractivo/camionetas/volcodoblecabina/interior/asientos.jpg";
import doblevolcohabitaculotecho from "~/public/buscadorinteractivo/camionetas/volcodoblecabina/interior/techo.jpg";
...
const DobleVolcoHabitaculo = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push(
            "/searchinteractive/camionetas/volcodoblecabina/searchdoblevolcomotorelectrico"
        );
    };
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    doblevolcohabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    doblevolcohabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
...
export default DobleVolcoHabitaculo;
