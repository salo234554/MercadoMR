...
//import ContainerInteractive from "~/components/layouts/ContainerInteractive";
import ContainerInteractive from "~/components/layouts/Container";
...
const SUVCincoPuertasLatoneriaIzquierda = (props) => {
    ...
    return (
        <ContainerInteractive title="Mi Cuenta">
            <div className="App">
...
export default SUVCincoPuertasLatoneriaIzquierda;
