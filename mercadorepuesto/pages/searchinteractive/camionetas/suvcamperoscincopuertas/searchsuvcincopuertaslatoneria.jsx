...
//Importafotos
import suvcincopuertasgris from "~/public/buscadorinteractivo/camionetas/suvcamperoscincopuertas/exterior/basegris.jpg";
...
const SearchInteractiveSUVCincoPuertasLatoneria = (props) => {
                        ...
                        <div className={controlFijar}>
                            ...
                            <div className="cajatrespuertasimagenlatoneria">
                                <div className="auth__box-logo">
                                    <img src={suvcincopuertasgris.src} />
                                </div>
                            </div>
...
export default SearchInteractiveSUVCincoPuertasLatoneria;
