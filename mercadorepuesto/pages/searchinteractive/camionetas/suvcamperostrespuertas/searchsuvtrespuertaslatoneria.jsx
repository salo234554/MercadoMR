...
//Importafotos
import suvtrespuertasgris from "~/public/buscadorinteractivo/camionetas/suvcamperostrespuertas/exterior/basegris.jpg";
...
const SearchInteractiveSUVTresPuertasLatoneria = (props) => {
                        ...
                        <div className={controlFijar}>
                            ...
                            <div className="cajatrespuertasimagenlatoneria">
                                <div className="auth__box-logo">
                                    <img src={suvtrespuertasgris.src} />
                                </div>
                            </div>
...
export default SearchInteractiveSUVTresPuertasLatoneria;
