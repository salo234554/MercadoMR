...
//Importar Carrusel
import CalleLatoneria from "../../../CarruselVehiculos/Motos/Deportiva/DeportivaLatoneria";
...
const CalleLatoneriaDerecha = (props) => {
    ...
    const irLatoneriaCentro = () => {
        ...
        router.push(
            "/searchinteractive/motos/deportiva/searchdeportivalatoneriacentro"
        );
    };
    ...
    const irLatoneriaDerecha = () => {
        ...
        router.push(
            "/searchinteractive/motos/deportiva/searchdeportivalatoneriaderecha"
        );
    };
                            ...
                            <Row>
                                <Col xs lg={7}>
                                    <div className="cajaimagenesmotos auth__box-logo">
                                        <CalleLatoneria ubicacion={"derecha"} />
                                    </div>
                                </Col>
                            </Row>
...
/*
 <div className="auth__box-logo">
                            ...
                            */
export default CalleLatoneriaDerecha;
