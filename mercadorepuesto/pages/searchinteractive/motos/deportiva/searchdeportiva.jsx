...
const SearchInteractiveDeportiva = (props) => {
    ...
    //Mensajes botones informacion vehiculos
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/motos/deportiva/videodeportiva.mp4"
...
export default SearchInteractiveDeportiva;
