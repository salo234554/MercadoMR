...
//Importar Carrusel
import DeportivaLatoneria from "../../../CarruselVehiculos/Motos/Deportiva/DeportivaLatoneria";

const DeportivaLatoneriaLatoneriaIzquierda = (props) => {
    ...
    const mostrarComentariolatoneria = () => {
        ...
        setShowModalComentariosLatoneria(true);
        setTextoUnoModalInformacion("Aquí están ubicados los productos en la parte exterior de la motocicleta");
    ...
    const seleccionaUbicarProductoLatoneria = () => {
        ...
        router.push("/searchinteractive/motos/deportiva/searchdeportivalatoneria");
    };
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push("/searchinteractive/motos/deportiva/searchdeportivamotorelectrico");
    };

    const irLatoneriaIzquierda = () => {
        dispatch(getFilterSearchInteractive(11));
        router.push(
            "/searchinteractive/motos/deportiva/searchdeportivalatoneriaizquierda"
        );
    };

    const irLatoneriaCentro = () => {
        dispatch(getFilterSearchInteractive(12));
        router.push("/searchinteractive/motos/deportiva/searchdeportivalatoneriacentro");
    };

    const irLatoneriaDerecha = () => {
        dispatch(getFilterSearchInteractive(13));
        router.push("/searchinteractive/motos/deportiva/searchdeportivalatoneriaderecha");
    };
                    ...
                    {!closeWindow ? (
                        <div className={controlFijar}>
                            ...
                            <div className="mt-3 centrartextosexterior">
                                Elige en que parte de la motocicleta está ubicado tu repuesto
                            </div>
                            <Row>
                                <Col xs lg={11}>
                                    <ButtonGroup>
...
export default DeportivaLatoneriaLatoneriaIzquierda;
