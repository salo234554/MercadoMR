...
const SearchInteractiveBusLatoneria = (props) => {
    ...
    const seleccionaUbicarProductoLatoneria = () => {
        ...
        router.push("/searchinteractive/motocarro/enduro/searchcallelatoneria");
    };
                                    ...
                                    <ButtonGroup>
                                        <div className="espaciosuperiorbordecarroceriasedan">
                                            <Row>
                                                ...
                                                <Col xs lg={2} className="ml-3">
                                                    <Button
                                                        className="informacionbotoncarroceriacentrocdidos"
                                                        variant="outline-light"
                                                        onClick={
