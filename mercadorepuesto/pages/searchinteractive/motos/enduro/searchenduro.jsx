...
const SearchInteractiveEnduro = (props) => {
    ...
    const seleccionaUbicarProductoLatoneria = () => {
        ...
        router.push(
            "/searchinteractive/motos/enduro/searchendurolatoneria"
        );
    };
                            ...
                            <div className="mt-45">
                                <div className="cajatrespuertasimagenlatoneria">
                                    <video autoPlay="false">
                                        <source
                                            src="/buscadorinteractivo/motos/enduro/videoenduro.mp4"
...
export default SearchInteractiveEnduro;
