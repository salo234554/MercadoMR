...
//Importar Carrusel
import BusesLatoneria from "../../../CarruselVehiculos/BusesYVans/Bus/BusesLatoneria";
...
const BusesLatoneriaDerecha = (props) => {
    ...
    const irLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/vansybuses/bus/searchbuslatoneriaizquierda"
        );
    };
    ...
    const irLatoneriaCentro = () => {
        ...
        router.push(
            "/searchinteractive/vansybuses/bus/searchbuslatoneriacentro"
        );
    };
    ...
    const irLatoneriaDerecha = () => {
        ...
        router.push(
            "/searchinteractive/vansybuses/bus/searchbuslatoneriaderecha"
        );
    };
                        ...
                        <div className={controlFijar}>
                            ...
                            <Row>
                                <div className="cajaimagenlatoneriachasissencillo auth__box-logo">
                                    <BusesLatoneria ubicacion={"derecha"} />
                                </div>
                            </Row>
...
/*
 <div className="auth__box-logo">
                            ...
                            */
export default BusesLatoneriaDerecha;
