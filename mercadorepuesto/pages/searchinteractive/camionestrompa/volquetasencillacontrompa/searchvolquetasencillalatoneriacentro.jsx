...
//Importar Carrusel
import VolquetaSencillaLatoneria from "../../../CarruselVehiculos/Camionestrompa/VolquetaSencillaConTrompa/VolquetaSencillaLatoneria";
...
const VolquetaSencillaLatoneriaCentro = (props) => {
    ...
    const irLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/camionestrompa/volquetasencillacontrompa/searchvolquetasencillalatoneriaizquierda"
        );
    };
    ...
    const irLatoneriaCentro = () => {
        ...
        router.push(
            "/searchinteractive/camionestrompa/volquetasencillacontrompa/searchvolquetasencillalatoneriacentro"
        );
    };
    ...
    const irLatoneriaDerecha = () => {
        ...
        router.push(
            "/searchinteractive/camionestrompa/volquetasencillacontrompa/searchvolquetasencillalatoneriaderecha"
        );
    };
...
export default VolquetaSencillaLatoneriaCentro;
