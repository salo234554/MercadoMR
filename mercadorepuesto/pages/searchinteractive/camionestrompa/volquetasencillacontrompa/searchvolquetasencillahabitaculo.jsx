...
//Importafotos
import volquetasencillahabitaculo from "~/public/buscadorinteractivo/camionestrompa/volquetasencillacontrompa/interior/general.jpg";
import volquetasencillahabitaculoconsola from "~/public/buscadorinteractivo/camionestrompa/volquetasencillacontrompa/interior/tablero.jpg";
import volquetasencillahabitaculoasientos from "~/public/buscadorinteractivo/camionestrompa/volquetasencillacontrompa/interior/asientos.jpg";
import volquetasencillahabitaculotecho from "~/public/buscadorinteractivo/camionestrompa/volquetasencillacontrompa/interior/techo.jpg";
...
const VolquetaSencillaHabitaculo = (props) => {
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        router.push(
            "/searchinteractive/camionestrompa/volquetasencillacontrompa/searchvolquetasencillamotorelectrico"
        );
    };
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        <div>
                                            <img
                                                ...
                                                src={
                                                    volquetasencillahabitaculo.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoConsola ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volquetasencillahabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volquetasencillahabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    volquetasencillahabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default VolquetaSencillaHabitaculo;
