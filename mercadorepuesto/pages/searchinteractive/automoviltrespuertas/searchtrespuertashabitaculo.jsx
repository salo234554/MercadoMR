...
//Importafotos
import trespuertashabitaculo from "~/public/buscadorinteractivo/automoviltrespuertas/interior/general.jpg";
import trespuertashabitaculoconsola from "~/public/buscadorinteractivo/automoviltrespuertas/interior/tablero.jpg";
import trespuertashabitaculoasientos from "~/public/buscadorinteractivo/automoviltrespuertas/interior/asientos.jpg";
import trespuertashabitaculotecho from "~/public/buscadorinteractivo/automoviltrespuertas/interior/techo.jpg";
...
const SearchInteractiveTresPuertasHabitaculo = (props) => {
                                    ...
                                    {ubicarProductoHabitaculo ? (
                                        ...
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    trespuertashabitaculoconsola.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoAsientoGeneral ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    trespuertashabitaculoasientos.src
                                                }
                                            />
                                        </div>
                                    ) : ubicarProductoTecho ? (
                                        <div>
                                            <img
                                                className="tamañoimageneshabitaculocincopuertas"
                                                src={
                                                    trespuertashabitaculotecho.src
                                                }
                                            />
                                        </div>
                                    ) : null}
...
export default SearchInteractiveTresPuertasHabitaculo;
