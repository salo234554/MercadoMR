...
//Importar Carrusel
import TresPuertasLatoneria from "../../CarruselVehiculos/CarruselTresPuertas/TresPuertasLatoneria";
...
const SearchInteractiveTresPuertasLatoneriaDerecha = (props) => {
    ...
    const mostrarComentariomotor = () => {
        ...
        setShowModalComentariosLatoneria(true);
        setTextoUnoModalInformacion(
            "Aquí están ubicados los productos en la parte exterior derecha del veículo."
        );
        setTextoDosModalInformacion(
            "Aquí encuentras productos relacionados con latonería, pintura, farolas entre otras "
        );
    };
...
/*
 <div className="auth__box-logo">
                            ...
                            */
export default SearchInteractiveTresPuertasLatoneriaDerecha;
