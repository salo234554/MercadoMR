...
//Importafotos
import sedangris from "~/public/buscadorinteractivo/sedan/exterior/basegris.jpg";
...
const SearchInteractiveSedan = (props) => {
    ...
    const [textoTituloInformacion, setTextoTituloInformacion] = useState("Vehículos Sedan");
    ...
    const seleccionaUbicarProductoLatoneriaIzquierda = () => {
        ...
        router.push(
            "/searchinteractive/sedan/searchsedanlatoneriaizquierda"
        );
    };
    ...
    const seleccionaUbicarProductoLatoneriaCentro = () => {
        ...
        dispatch(getDataSelectedExternal(DatoSeleccionadoLatoneria));
        router.push(
            "/searchinteractive/sedan/searchsedanlatoneriacentro"
        );
    };
    ...
    const seleccionaUbicarProductoLatoneriaDerecha = () => {
        ...
        dispatch(getDataSelectedExternal(DatoSeleccionadoLatoneria));
        router.push(
            "/searchinteractive/sedan/searchsedanlatoneriaderecha"
        );
    };
    ...
    const seleccionaUbicarProductoHabitaculo = () => {
        ...
        router.push(
            "/searchinteractive/sedan/searchsedanhabitaculo"
        );
    };
    ...
    const seleccionaUbicarProductoMotorElectrico = () => {
        ...
        /*router.push(
             "/searchinteractive/sedan/searchsedanlatoneriamotorelectrico"
         );*/
        if (tipovehsel != 4) {
            router.push(
                "/searchinteractive/sedan/searchsedanmotorelectrico"
            );
        } else {
            router.push(
