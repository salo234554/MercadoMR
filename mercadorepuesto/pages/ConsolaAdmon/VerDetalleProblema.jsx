...
export default function VerDetalleProblema() {
    ...
    const regresar = async () => {
        ...
        router.push("/ConsolaAdmon/ProblemasSinReponder");
    };

    const aceptarMensaje = async () => {
        let estadoacepta = 0;

        if (producto[0].estado == 31) estadoacepta = 32;
        else if (producto[0].estado == 33) estadoacepta = 34;
