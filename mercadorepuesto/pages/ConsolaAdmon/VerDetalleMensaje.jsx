...
export default function VerDetalleMensaje() {
    ...
    const regresar = async () => {
        ...
        router.push("/ConsolaAdmon/PreguntasSinReponder");
    };

    const aceptarMensaje = async () => {
        let estadoacepta = 0;

        if (producto[0].estado == 41) estadoacepta = 42;
        else if (producto[0].estado == 43) estadoacepta = 44;
